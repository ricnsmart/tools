...
func (*Address) Descriptor() ([]byte, []int) {
	return fileDescriptor_amap_bdaff3fd031e33ed, []int{0}
}
...
func (*Location) Descriptor() ([]byte, []int) {
	return fileDescriptor_amap_bdaff3fd031e33ed, []int{1}
}
...
func (m *Geocodes) Reset()         { *m = Geocodes{} }
func (m *Geocodes) String() string { return proto.CompactTextString(m) }
func (*Geocodes) ProtoMessage()    {}
func (*Geocodes) Descriptor() ([]byte, []int) {
	return fileDescriptor_amap_bdaff3fd031e33ed, []int{2}
}
func (m *Geocodes) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Geocodes.Unmarshal(m, b)
}
func (m *Geocodes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Geocodes.Marshal(b, m, deterministic)
}
func (dst *Geocodes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Geocodes.Merge(dst, src)
}
func (m *Geocodes) XXX_Size() int {
	return xxx_messageInfo_Geocodes.Size(m)
}
func (m *Geocodes) XXX_DiscardUnknown() {
	xxx_messageInfo_Geocodes.DiscardUnknown(m)
}

var xxx_messageInfo_Geocodes proto.InternalMessageInfo
...
func (*Geocode) Descriptor() ([]byte, []int) {
	return fileDescriptor_amap_bdaff3fd031e33ed, []int{3}
}
...
func init() {
	...
	proto.RegisterType((*Geocodes)(nil), "amap.Geocodes")
...
func init() { proto.RegisterFile("amap.proto", fileDescriptor_amap_bdaff3fd031e33ed) }

var fileDescriptor_amap_bdaff3fd031e33ed = []byte{
	...
	,
}
